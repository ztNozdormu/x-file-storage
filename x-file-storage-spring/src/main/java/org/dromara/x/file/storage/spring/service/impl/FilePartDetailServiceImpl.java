...
public class FilePartDetailServiceImpl extends ServiceImpl<FilePartDetailMapper, FilePartDetail>
    ...
    public FilePartDetailServiceImpl(FilePartDetailMapper filePartDetailMapper) {
        super.baseMapper = filePartDetailMapper;
    }
    ...
    @Override
    public void saveFilePart(FilePartInfo info, String tableSuffix) {
        MybatisPlusUtils.setDynamicTableName(BaseTableNameEnum.HOS_FILE_DETAIL.tableName() + "_" + tableSuffix);
        saveFilePart(info);
    }

    @Override
    public void deleteFilePartByUploadId(String uploadId, String tableSuffix) {
        MybatisPlusUtils.setDynamicTableName(BaseTableNameEnum.HOS_FILE_DETAIL.tableName() + "_" + tableSuffix);
        deleteFilePartByUploadId(uploadId);
    }
}
